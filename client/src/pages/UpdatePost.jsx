...
export default function UpdatePost() {
  ...
  const handleUploadImage = async () => {
    try {
    if (!file){
      setImageUploadError('Please select an image to continue');
      return;
    }
    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-4 sm:flex-row justify-between'>
          <TextInput type='text' placeholder='Create a title' required id='title' className='flex-1'onChange={(e) =>
        ...
        <ReactQuill theme='snow' value={formData.content} placeholder='Type your mind...' className='h-72 mb-12' required
          onChange={(value) => {
